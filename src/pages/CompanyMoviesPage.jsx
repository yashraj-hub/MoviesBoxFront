...
export default function CompanyMoviesPage() {
  const [searchParams] = useSearchParams()
  const navigate = useNavigate()
  const companyId = searchParams.get('id')
  const companyName = searchParams.get('name') || 'Production company'
  ...
  const fetchMovies = useCallback(
    async (p) => {
      const url = `company/${companyId}/movies?page=${p}`
